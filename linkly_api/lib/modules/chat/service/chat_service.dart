...
import 'package:dart_application/application/facades/push_notification_facede.dart';
import 'package:dart_application/entities/chat.dart';
import 'package:dart_application/modules/chat/data/i_chat_repository.dart';
import 'package:dart_application/modules/chat/service/i_chat_service.dart';
...
class ChatService implements IChatService {
  ...
  void _notifyUser(List<String?>? tokens, ChatNotifyViewModel model, Chat chat) {
